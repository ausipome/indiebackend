...
export namespace Prisma {
  ...
  */
  ...
  export type UserCountOutputType = {
    ...
    orders: number
    products: number
    from_OrderItem_user: number
    from_Chat_userFrom: number
  }
  ...
  export type UserCountOutputTypeSelect = {
    ...
    orders?: boolean
    products?: boolean
    from_OrderItem_user?: boolean
    from_Chat_userFrom?: boolean
  }
  ...
  export type ProductImageCountOutputTypeGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof ProductImageCountOutputType ? ProductImageCountOutputType[P] : never
  } 
    : ProductImageCountOutputType
  : ProductImageCountOutputType
  ...
  export type OrderItemCountOutputTypeGetPayload<
    S extends boolean | null | undefined | OrderItemCountOutputTypeArgs,
    U = keyof S
      > = S extends true
        ? OrderItemCountOutputType
    : S extends undefined
    ? never
    : S extends OrderItemCountOutputTypeArgs
    ?'include' extends U
    ? OrderItemCountOutputType 
    : 'select' extends U
    ? {
  ...
  export type UserSelect = {
    ...
    from_OrderItem_user?: boolean | OrderItemFindManyArgs
    from_Chat_userFrom?: boolean | ChatFindManyArgs
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'role' ? RoleGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'products' ? Array < ProductGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'from_OrderItem_user' ? Array < OrderItemGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'from_Chat_userFrom' ? Array < ChatGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'role' ? RoleGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'products' ? Array < ProductGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'from_OrderItem_user' ? Array < OrderItemGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'from_Chat_userFrom' ? Array < ChatGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__UserClient<T> implements PrismaPromise<T> {
    ...
    from_OrderItem_user<T extends OrderItemFindManyArgs = {}>(args?: Subset<T, OrderItemFindManyArgs>): CheckSelect<T, PrismaPromise<Array<OrderItem>>, PrismaPromise<Array<OrderItemGetPayload<T>>>>;

    from_Chat_userFrom<T extends ChatFindManyArgs = {}>(args?: Subset<T, ChatFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Chat>>, PrismaPromise<Array<ChatGetPayload<T>>>>;
  ...
  export type ProductGetPayload<
    ...
    ? Product  & {
    [P in TrueKeys<S['include']>]:
        P extends 'photo' ? ProductImageGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'user' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'from_CartItem_product' ? Array < CartItemGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? ProductCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'photo' ? ProductImageGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'user' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'from_CartItem_product' ? Array < CartItemGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export type ProductImageGetPayload<
    ...
    ? ProductImage  & {
    [P in TrueKeys<S['include']>]:
        P extends 'product' ? ProductGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'from_OrderItem_photo' ? Array < OrderItemGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? ProductImageCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'product' ? ProductGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'from_OrderItem_photo' ? Array < OrderItemGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? ProductImageCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof ProductImage ? ProductImage[P] : never
  } 
    : ProductImage
  : ProductImage
  ...
  export type CartItemGetPayload<
    ...
    [P in TrueKeys<S['select']>]:
        P extends 'product' ? ProductGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'user' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof CartItem ? CartItem[P] : never
  } 
    : CartItem
  : CartItem
  ...
  export type OrderItemGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'chat' ? Array < ChatGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'user' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends '_count' ? OrderItemCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'chat' ? Array < ChatGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'user' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends '_count' ? OrderItemCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof OrderItem ? OrderItem[P] : never
  } 
    : OrderItem
  : OrderItem
  ...
  export class Prisma__OrderItemClient<T> implements PrismaPromise<T> {
    ...
    chat<T extends ChatFindManyArgs = {}>(args?: Subset<T, ChatFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Chat>>, PrismaPromise<Array<ChatGetPayload<T>>>>;
  ...
  export type OrderGetPayload<
    ...
    ? Order  & {
    [P in TrueKeys<S['include']>]:
        P extends 'items' ? Array < OrderItemGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'user' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'items' ? Array < OrderItemGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'user' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
  ...
  export type RoleGetPayload<
    ...
    ? Role  & {
    [P in TrueKeys<S['include']>]:
        P extends 'assignedTo' ? Array < UserGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? RoleCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'assignedTo' ? Array < UserGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export type ChatGetPayload<
    ...
    ? Chat  & {
    [P in TrueKeys<S['include']>]:
        P extends 'userFrom' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'item' ? OrderItemGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'userFrom' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'item' ? OrderItemGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof Chat ? Chat[P] : never
  } 
    : Chat
  : Chat
  ...
  export class Prisma__ChatClient<T> implements PrismaPromise<T> {
    ...
    userFrom<T extends UserArgs = {}>(args?: Subset<T, UserArgs>): CheckSelect<T, Prisma__UserClient<User | null >, Prisma__UserClient<UserGetPayload<T> | null >>;

    item<T extends OrderItemArgs = {}>(args?: Subset<T, OrderItemArgs>): CheckSelect<T, Prisma__OrderItemClient<OrderItem | null >, Prisma__OrderItemClient<OrderItemGetPayload<T> | null >>;
  ...
  export type UserWhereInput = {
    ...
    confirmed?: StringFilter | string
    address?: StringFilter | string
    address2?: StringFilter | string
    town?: StringFilter | string
    ...
    from_OrderItem_user?: OrderItemListRelationFilter
    from_Chat_userFrom?: ChatListRelationFilter
  }
  ...
  export type UserOrderByWithRelationInput = {
    ...
    from_OrderItem_user?: OrderItemOrderByRelationAggregateInput
    from_Chat_userFrom?: ChatOrderByRelationAggregateInput
  }
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    confirmed?: StringWithAggregatesFilter | string
    address?: StringWithAggregatesFilter | string
    address2?: StringWithAggregatesFilter | string
    town?: StringWithAggregatesFilter | string
  ...
  export type OrderItemWhereInput = {
    ...
    status?: StringNullableFilter | string | null
    tracking?: StringFilter | string
    trackingCompany?: StringFilter | string
    email?: StringFilter | string
    user?: XOR<UserRelationFilter, UserWhereInput> | null
    userId?: StringNullableFilter | string | null
  ...
  export type OrderItemScalarWhereWithAggregatesInput = {
    ...
    status?: StringNullableWithAggregatesFilter | string | null
    tracking?: StringWithAggregatesFilter | string
    trackingCompany?: StringWithAggregatesFilter | string
    email?: StringWithAggregatesFilter | string
    userId?: StringNullableWithAggregatesFilter | string | null
  ...
  export type ChatWhereInput = {
    ...
    id?: StringFilter | string
    userFrom?: XOR<UserRelationFilter, UserWhereInput> | null
    userFromId?: StringNullableFilter | string | null
  ...
  export type ChatScalarWhereWithAggregatesInput = {
    ...
    id?: StringWithAggregatesFilter | string
    userFromId?: StringNullableWithAggregatesFilter | string | null
  ...
  export type UserCreateInput = {
    ...
    from_OrderItem_user?: OrderItemCreateNestedManyWithoutUserInput
    from_Chat_userFrom?: ChatCreateNestedManyWithoutUserFromInput
  }
  ...
  export type UserUncheckedCreateInput = {
    ...
    passwordResetIssuedAt?: Date | string | null
    passwordResetRedeemedAt?: Date | string | null
    from_OrderItem_user?: OrderItemUncheckedCreateNestedManyWithoutUserInput
    from_Chat_userFrom?: ChatUncheckedCreateNestedManyWithoutUserFromInput
  }
  ...
  export type UserUpdateInput = {
    ...
    role?: RoleUpdateOneWithoutAssignedToNestedInput
    ...
    from_OrderItem_user?: OrderItemUpdateManyWithoutUserNestedInput
    from_Chat_userFrom?: ChatUpdateManyWithoutUserFromNestedInput
  }
  ...
  export type UserUncheckedUpdateInput = {
    ...
    passwordResetIssuedAt?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    passwordResetRedeemedAt?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    from_OrderItem_user?: OrderItemUncheckedUpdateManyWithoutUserNestedInput
    from_Chat_userFrom?: ChatUncheckedUpdateManyWithoutUserFromNestedInput
  }
  ...
  export type ProductUpdateInput = {
    ...
    photo?: ProductImageUpdateOneWithoutProductNestedInput
    status?: NullableStringFieldUpdateOperationsInput | string | null
    condition?: NullableStringFieldUpdateOperationsInput | string | null
    price?: NullableIntFieldUpdateOperationsInput | number | null
    email?: StringFieldUpdateOperationsInput | string
    user?: UserUpdateOneWithoutProductsNestedInput
    from_CartItem_product?: CartItemUpdateManyWithoutProductNestedInput
  }
  ...
  export type ProductUncheckedUpdateInput = {
    ...
    from_CartItem_product?: CartItemUncheckedUpdateManyWithoutProductNestedInput
  }
  ...
  export type ProductImageUpdateInput = {
    ...
    product?: ProductUpdateOneWithoutPhotoNestedInput
    from_OrderItem_photo?: OrderItemUpdateManyWithoutPhotoNestedInput
  }
  ...
  export type ProductImageUncheckedUpdateInput = {
    ...
    image?: NullableJsonNullValueInput | InputJsonValue
    altText?: StringFieldUpdateOperationsInput | string
    product?: ProductUncheckedUpdateOneWithoutPhotoNestedInput
    from_OrderItem_photo?: OrderItemUncheckedUpdateManyWithoutPhotoNestedInput
  }
  ...
  export type CartItemUpdateInput = {
    ...
    product?: ProductUpdateOneWithoutFrom_CartItem_productNestedInput
  ...
  export type OrderItemCreateInput = {
    ...
    chat?: ChatCreateNestedManyWithoutItemInput
    status?: string | null
    tracking?: string
    trackingCompany?: string
    email?: string
    user?: UserCreateNestedOneWithoutFrom_OrderItem_userInput
  ...
  export type OrderItemUncheckedCreateInput = {
    ...
    quantity?: number | null
    orderId?: string | null
    chat?: ChatUncheckedCreateNestedManyWithoutItemInput
    status?: string | null
    tracking?: string
    trackingCompany?: string
    email?: string
  ...
  export type OrderItemUpdateInput = {
    ...
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    photo?: ProductImageUpdateOneWithoutFrom_OrderItem_photoNestedInput
    price?: NullableIntFieldUpdateOperationsInput | number | null
    quantity?: NullableIntFieldUpdateOperationsInput | number | null
    order?: OrderUpdateOneWithoutItemsNestedInput
    chat?: ChatUpdateManyWithoutItemNestedInput
    status?: NullableStringFieldUpdateOperationsInput | string | null
    tracking?: StringFieldUpdateOperationsInput | string
    trackingCompany?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    user?: UserUpdateOneWithoutFrom_OrderItem_userNestedInput
  ...
  export type OrderItemUncheckedUpdateInput = {
    ...
    chat?: ChatUncheckedUpdateManyWithoutItemNestedInput
    status?: NullableStringFieldUpdateOperationsInput | string | null
    tracking?: StringFieldUpdateOperationsInput | string
    trackingCompany?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
  ...
  export type RoleUpdateInput = {
    ...
    assignedTo?: UserUpdateManyWithoutRoleNestedInput
  }
  ...
  export type RoleUncheckedUpdateInput = {
    ...
    canManageCart?: BoolFieldUpdateOperationsInput | boolean
    canManageOrders?: BoolFieldUpdateOperationsInput | boolean
    assignedTo?: UserUncheckedUpdateManyWithoutRoleNestedInput
  }
  ...
  export type ChatCreateInput = {
    id?: string
    userFrom?: UserCreateNestedOneWithoutFrom_Chat_userFromInput
    item?: OrderItemCreateNestedOneWithoutChatInput
    timeStamp?: Date | string | null
    message?: string
  }
  ...
  export type ChatUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    userFrom?: UserUpdateOneWithoutFrom_Chat_userFromNestedInput
    item?: OrderItemUpdateOneWithoutChatNestedInput
    timeStamp?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  ...
  export type ChatUncheckedUpdateInput = {
    id?: StringFieldUpdateOperationsInput | string
    userFromId?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type ChatCreateNestedManyWithoutUserFromInput = {
    create?: XOR<Enumerable<ChatCreateWithoutUserFromInput>, Enumerable<ChatUncheckedCreateWithoutUserFromInput>>
    connectOrCreate?: Enumerable<ChatCreateOrConnectWithoutUserFromInput>
  ...
  export type ChatUncheckedCreateNestedManyWithoutUserFromInput = {
    create?: XOR<Enumerable<ChatCreateWithoutUserFromInput>, Enumerable<ChatUncheckedCreateWithoutUserFromInput>>
    connectOrCreate?: Enumerable<ChatCreateOrConnectWithoutUserFromInput>
    createMany?: ChatCreateManyUserFromInputEnvelope
    connect?: Enumerable<ChatWhereUniqueInput>
  ...
  export type RoleUpdateOneWithoutAssignedToNestedInput = {
    create?: XOR<RoleCreateWithoutAssignedToInput, RoleUncheckedCreateWithoutAssignedToInput>
    connectOrCreate?: RoleCreateOrConnectWithoutAssignedToInput
  ...
  export type ChatUpdateManyWithoutUserFromNestedInput = {
    create?: XOR<Enumerable<ChatCreateWithoutUserFromInput>, Enumerable<ChatUncheckedCreateWithoutUserFromInput>>
    connectOrCreate?: Enumerable<ChatCreateOrConnectWithoutUserFromInput>
    upsert?: Enumerable<ChatUpsertWithWhereUniqueWithoutUserFromInput>
    createMany?: ChatCreateManyUserFromInputEnvelope
    set?: Enumerable<ChatWhereUniqueInput>
    disconnect?: Enumerable<ChatWhereUniqueInput>
    delete?: Enumerable<ChatWhereUniqueInput>
    connect?: Enumerable<ChatWhereUniqueInput>
    update?: Enumerable<ChatUpdateWithWhereUniqueWithoutUserFromInput>
    updateMany?: Enumerable<ChatUpdateManyWithWhereWithoutUserFromInput>
  ...
  export type ChatUncheckedUpdateManyWithoutUserFromNestedInput = {
    create?: XOR<Enumerable<ChatCreateWithoutUserFromInput>, Enumerable<ChatUncheckedCreateWithoutUserFromInput>>
    connectOrCreate?: Enumerable<ChatCreateOrConnectWithoutUserFromInput>
    upsert?: Enumerable<ChatUpsertWithWhereUniqueWithoutUserFromInput>
    createMany?: ChatCreateManyUserFromInputEnvelope
  ...
  export type OrderItemCreateNestedManyWithoutPhotoInput = {
    ...
    createMany?: OrderItemCreateManyPhotoInputEnvelope
    connect?: Enumerable<OrderItemWhereUniqueInput>
  }
  ...
  export type ProductUpdateOneWithoutPhotoNestedInput = {
    create?: XOR<ProductCreateWithoutPhotoInput, ProductUncheckedCreateWithoutPhotoInput>
    connectOrCreate?: ProductCreateOrConnectWithoutPhotoInput
  ...
  export type OrderItemUpdateManyWithoutPhotoNestedInput = {
    create?: XOR<Enumerable<OrderItemCreateWithoutPhotoInput>, Enumerable<OrderItemUncheckedCreateWithoutPhotoInput>>
    connectOrCreate?: Enumerable<OrderItemCreateOrConnectWithoutPhotoInput>
  ...
  export type ProductUncheckedUpdateOneWithoutPhotoNestedInput = {
    create?: XOR<ProductCreateWithoutPhotoInput, ProductUncheckedCreateWithoutPhotoInput>
    connectOrCreate?: ProductCreateOrConnectWithoutPhotoInput
    upsert?: ProductUpsertWithoutPhotoInput
    disconnect?: boolean
  ...
  export type OrderItemUncheckedUpdateManyWithoutPhotoNestedInput = {
    create?: XOR<Enumerable<OrderItemCreateWithoutPhotoInput>, Enumerable<OrderItemUncheckedCreateWithoutPhotoInput>>
    connectOrCreate?: Enumerable<OrderItemCreateOrConnectWithoutPhotoInput>
    upsert?: Enumerable<OrderItemUpsertWithWhereUniqueWithoutPhotoInput>
    createMany?: OrderItemCreateManyPhotoInputEnvelope
  ...
  export type ProductUpdateOneWithoutFrom_CartItem_productNestedInput = {
    create?: XOR<ProductCreateWithoutFrom_CartItem_productInput, ProductUncheckedCreateWithoutFrom_CartItem_productInput>
    connectOrCreate?: ProductCreateOrConnectWithoutFrom_CartItem_productInput
  ...
  export type UserCreateNestedOneWithoutFrom_OrderItem_userInput = {
    create?: XOR<UserCreateWithoutFrom_OrderItem_userInput, UserUncheckedCreateWithoutFrom_OrderItem_userInput>
    connectOrCreate?: UserCreateOrConnectWithoutFrom_OrderItem_userInput
    connect?: UserWhereUniqueInput
  }
  ...
  export type ProductImageUpdateOneWithoutFrom_OrderItem_photoNestedInput = {
    create?: XOR<ProductImageCreateWithoutFrom_OrderItem_photoInput, ProductImageUncheckedCreateWithoutFrom_OrderItem_photoInput>
    connectOrCreate?: ProductImageCreateOrConnectWithoutFrom_OrderItem_photoInput
  ...
  export type UserUpdateOneWithoutFrom_OrderItem_userNestedInput = {
    create?: XOR<UserCreateWithoutFrom_OrderItem_userInput, UserUncheckedCreateWithoutFrom_OrderItem_userInput>
    connectOrCreate?: UserCreateOrConnectWithoutFrom_OrderItem_userInput
    upsert?: UserUpsertWithoutFrom_OrderItem_userInput
    disconnect?: boolean
    delete?: boolean
    connect?: UserWhereUniqueInput
    update?: XOR<UserUpdateWithoutFrom_OrderItem_userInput, UserUncheckedUpdateWithoutFrom_OrderItem_userInput>
  }
  ...
  export type UserCreateNestedOneWithoutFrom_Chat_userFromInput = {
    create?: XOR<UserCreateWithoutFrom_Chat_userFromInput, UserUncheckedCreateWithoutFrom_Chat_userFromInput>
    connectOrCreate?: UserCreateOrConnectWithoutFrom_Chat_userFromInput
    connect?: UserWhereUniqueInput
  }

  export type OrderItemCreateNestedOneWithoutChatInput = {
    create?: XOR<OrderItemCreateWithoutChatInput, OrderItemUncheckedCreateWithoutChatInput>
    connectOrCreate?: OrderItemCreateOrConnectWithoutChatInput
    connect?: OrderItemWhereUniqueInput
  }

  export type UserUpdateOneWithoutFrom_Chat_userFromNestedInput = {
    create?: XOR<UserCreateWithoutFrom_Chat_userFromInput, UserUncheckedCreateWithoutFrom_Chat_userFromInput>
    connectOrCreate?: UserCreateOrConnectWithoutFrom_Chat_userFromInput
    upsert?: UserUpsertWithoutFrom_Chat_userFromInput
    disconnect?: boolean
    delete?: boolean
    connect?: UserWhereUniqueInput
    update?: XOR<UserUpdateWithoutFrom_Chat_userFromInput, UserUncheckedUpdateWithoutFrom_Chat_userFromInput>
  }

  export type OrderItemUpdateOneWithoutChatNestedInput = {
    create?: XOR<OrderItemCreateWithoutChatInput, OrderItemUncheckedCreateWithoutChatInput>
    connectOrCreate?: OrderItemCreateOrConnectWithoutChatInput
    upsert?: OrderItemUpsertWithoutChatInput
    disconnect?: boolean
    delete?: boolean
    connect?: OrderItemWhereUniqueInput
    update?: XOR<OrderItemUpdateWithoutChatInput, OrderItemUncheckedUpdateWithoutChatInput>
  }
  ...
  export type ChatCreateWithoutUserFromInput = {
    id?: string
    item?: OrderItemCreateNestedOneWithoutChatInput
    timeStamp?: Date | string | null
    message?: string
  ...
  export type ChatUncheckedCreateWithoutUserFromInput = {
    id?: string
    itemId?: string | null
    timeStamp?: Date | string | null
    message?: string
  ...
  export type ChatCreateOrConnectWithoutUserFromInput = {
    where: ChatWhereUniqueInput
    create: XOR<ChatCreateWithoutUserFromInput, ChatUncheckedCreateWithoutUserFromInput>
  }

  export type ChatCreateManyUserFromInputEnvelope = {
    data: Enumerable<ChatCreateManyUserFromInput>
    skipDuplicates?: boolean
  }
  ...
  export type OrderItemUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<OrderItemUpdateManyMutationInput, OrderItemUncheckedUpdateManyWithoutFrom_OrderItem_userInput>
  }
  ...
  export type ChatUpsertWithWhereUniqueWithoutUserFromInput = {
    where: ChatWhereUniqueInput
    update: XOR<ChatUpdateWithoutUserFromInput, ChatUncheckedUpdateWithoutUserFromInput>
    create: XOR<ChatCreateWithoutUserFromInput, ChatUncheckedCreateWithoutUserFromInput>
  }

  export type ChatUpdateWithWhereUniqueWithoutUserFromInput = {
    where: ChatWhereUniqueInput
    data: XOR<ChatUpdateWithoutUserFromInput, ChatUncheckedUpdateWithoutUserFromInput>
  }

  export type ChatUpdateManyWithWhereWithoutUserFromInput = {
    where: ChatScalarWhereInput
    data: XOR<ChatUpdateManyMutationInput, ChatUncheckedUpdateManyWithoutFrom_Chat_userFromInput>
  }
  ...
  export type OrderItemCreateManyPhotoInputEnvelope = {
    data: Enumerable<OrderItemCreateManyPhotoInput>
    skipDuplicates?: boolean
  }
  ...
  export type UserCreateWithoutFrom_OrderItem_userInput = {
    id?: string
    name?: string
    email?: string
    password?: string | null
  ...
  export type UserUncheckedCreateWithoutFrom_OrderItem_userInput = {
    id?: string
    name?: string
    email?: string
    password?: string | null
  ...
  export type UserCreateOrConnectWithoutFrom_OrderItem_userInput = {
    where: UserWhereUniqueInput
    create: XOR<UserCreateWithoutFrom_OrderItem_userInput, UserUncheckedCreateWithoutFrom_OrderItem_userInput>
  }
  ...
  export type UserUpsertWithoutFrom_OrderItem_userInput = {
    update: XOR<UserUpdateWithoutFrom_OrderItem_userInput, UserUncheckedUpdateWithoutFrom_OrderItem_userInput>
    create: XOR<UserCreateWithoutFrom_OrderItem_userInput, UserUncheckedCreateWithoutFrom_OrderItem_userInput>
  }

  export type UserUpdateWithoutFrom_OrderItem_userInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    password?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type UserUncheckedUpdateWithoutFrom_OrderItem_userInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    password?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type UserCreateWithoutFrom_Chat_userFromInput = {
    id?: string
    name?: string
    email?: string
    password?: string | null
  ...
  export type UserUncheckedCreateWithoutFrom_Chat_userFromInput = {
    id?: string
    name?: string
    email?: string
    password?: string | null
  ...
  export type UserCreateOrConnectWithoutFrom_Chat_userFromInput = {
    where: UserWhereUniqueInput
    create: XOR<UserCreateWithoutFrom_Chat_userFromInput, UserUncheckedCreateWithoutFrom_Chat_userFromInput>
  }

  export type OrderItemCreateWithoutChatInput = {
    id?: string
    name?: string
    description?: string
    photo?: ProductImageCreateNestedOneWithoutFrom_OrderItem_photoInput
  ...
  export type OrderItemUncheckedCreateWithoutChatInput = {
    id?: string
    name?: string
    description?: string
    photoId?: string | null
  ...
  export type OrderItemCreateOrConnectWithoutChatInput = {
    where: OrderItemWhereUniqueInput
    create: XOR<OrderItemCreateWithoutChatInput, OrderItemUncheckedCreateWithoutChatInput>
  }

  export type UserUpsertWithoutFrom_Chat_userFromInput = {
    update: XOR<UserUpdateWithoutFrom_Chat_userFromInput, UserUncheckedUpdateWithoutFrom_Chat_userFromInput>
    create: XOR<UserCreateWithoutFrom_Chat_userFromInput, UserUncheckedCreateWithoutFrom_Chat_userFromInput>
  }

  export type UserUpdateWithoutFrom_Chat_userFromInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    password?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type UserUncheckedUpdateWithoutFrom_Chat_userFromInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    password?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type OrderItemUpsertWithoutChatInput = {
    update: XOR<OrderItemUpdateWithoutChatInput, OrderItemUncheckedUpdateWithoutChatInput>
    create: XOR<OrderItemCreateWithoutChatInput, OrderItemUncheckedCreateWithoutChatInput>
  }

  export type OrderItemUpdateWithoutChatInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    photo?: ProductImageUpdateOneWithoutFrom_OrderItem_photoNestedInput
  ...
  export type OrderItemUncheckedUpdateWithoutChatInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    photoId?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type ChatCreateManyUserFromInput = {
    id?: string
    itemId?: string | null
    timeStamp?: Date | string | null
    message?: string
  ...
  export type OrderItemUncheckedUpdateManyWithoutFrom_OrderItem_userInput = {
    id?: StringFieldUpdateOperationsInput | string
    name?: StringFieldUpdateOperationsInput | string
    description?: StringFieldUpdateOperationsInput | string
    photoId?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type ChatUpdateWithoutUserFromInput = {
    id?: StringFieldUpdateOperationsInput | string
    item?: OrderItemUpdateOneWithoutChatNestedInput
    timeStamp?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    message?: StringFieldUpdateOperationsInput | string
  ...
  export type ChatUncheckedUpdateWithoutUserFromInput = {
    id?: StringFieldUpdateOperationsInput | string
    itemId?: NullableStringFieldUpdateOperationsInput | string | null
    timeStamp?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    message?: StringFieldUpdateOperationsInput | string
  ...
  export type ChatUncheckedUpdateManyWithoutFrom_Chat_userFromInput = {
    id?: StringFieldUpdateOperationsInput | string
    itemId?: NullableStringFieldUpdateOperationsInput | string | null
    timeStamp?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    message?: StringFieldUpdateOperationsInput | string
  ...
  export type OrderItemCreateManyPhotoInput = {
    id?: string
    name?: string
    description?: string
    price?: number | null
