...
const _excluded$7 = ["as"],
  _excluded2$1 = ["background", "foreground", "height", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginY", "marginX", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingY", "paddingX", "rounding", "roundingBottom", "roundingLeft", "roundingRight", "roundingTop", "textAlign", "width"];
// Style Functions
// ---------------
...
const useBoxStyles = _ref => {
  ...
  return mq(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, resolvedColors), resolvedMargin), resolvedPadding), resolvedRounding), {}, {
...
const Box = forwardRefWithAs((_ref10, ref) => {
  let {
    ...
    props = _objectWithoutProperties(_ref10, _excluded$7);
  const {
      background,
      foreground,
      height,
    ...
    attrs = _objectWithoutProperties(props, _excluded2$1);
...
const _excluded$5 = ["orientation", "color"];
...
const _excluded$3 = ["align", "children", "gap"];
const alignment$1 = {
  center: 'center',
  end: 'flex-end',
  start: 'flex-start',
...
const _excluded$1 = ["across", "align", "children", "dividers", "gap"];
const alignment = {
  center: 'center',
  end: 'flex-end',
  start: 'flex-start',
...
const _excluded = ["color", "leading", "size", "tracking", "weight"];
