...
const _excluded = ["animate", "fill", "onChange", "segments", "isDisabled", "isReadOnly", "size", "width", "selectedIndex"],
  _excluded2 = ["fill", "size", "width"],
  _excluded3 = ["children", "fill", "isAnimated", "isSelected", "onChange", "size", "value", "disabled", "readOnly"],
  _excluded4 = ["size"];
...
const Item = props => {
  ...
  return core.jsx("label", {
    css: _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, sizeStyles[size]), !isAnimated && isSelected && selectedStyles), {}, {
      boxSizing: 'border-box',
