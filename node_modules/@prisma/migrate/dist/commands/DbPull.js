...
`);
    ...
    const schema = await (0, import_ts_pattern.match)({ url, schemaPath }).when(
...
Some information will be lost (relations, comments, mapped fields, @ignore...), follow ${(0, import_internals.link)(
    ...
    const engine = new import_internals.IntrospectionEngine({
...
Please fix your current schema manually, use ${import_chalk.default.green(
